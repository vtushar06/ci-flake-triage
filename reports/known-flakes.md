...
Generated 2026-08-27 from the rerun history. 1676 completed runs (2026-06-01 to 2026-08-25), 469 re-run by hand, 681 confirmed flakes - 494 of them in 177 signatures, the rest with no marker or no log.
...
## test failures (452 flakes, 174 signatures)

| n | signature | window | issue candidate |
|---|---|---|---|
| 35 | `not ok \|N\| podman healthcheck` | 2026-06-02 to 2026-08-17 | #23871 needs-check |
| 16 | `[FAIL] run cp commands [DeferCleanup (Each)] podman cp` | 2026-06-16 to 2026-08-24 |  |
...
| 12 | `[FAIL] Podman rmi [It] podman image rm - concurrent with shared layers` | 2026-06-08 to 2026-08-17 |  |
| 11 | `not ok \|N\| quadlet - image tag` | 2026-06-02 to 2026-08-19 | #24598 needs-check |
| 11 | `[FAIL] Podman run networking [It] podman run container with two static IPs one per subnet` | 2026-06-04 to 2026-08-19 |  |
| 8 | `[FAIL] Podman run memory [It] podman run memory test on oomkilled container` | 2026-06-08 to 2026-08-19 |  |
...
| 7 | `[FAIL] podman machine init [It] machine init with cpus, disk size, memory, timezone` | 2026-06-02 to 2026-08-19 |  |
...
| 5 | `[FAIL] Podman run networking [It] podman run bridge multiple containers same network diffe` | 2026-08-10 to 2026-08-19 |  |
| 5 | `not ok \|N\| podman mount - basic test` | 2026-06-11 to 2026-07-14 | #24223 needs-check |
| 5 | `not ok [N] podman networking: port with --userns=keep-id for rootless or --uidmap=* for ro` | 2026-06-01 to 2026-08-14 |  |
| 5 | `not ok [N] podman network create` | 2026-06-01 to 2026-08-16 | #17288 needs-check |
| 5 | `not ok [N] podman run - default_host_ips from containers.conf` | 2026-06-11 to 2026-06-28 |  |
| 5 | `[FAIL] Podman build [It] podman build --build-context: URL source` | 2026-06-12 to 2026-08-12 |  |
...
| 4 | `not ok \|N\| events - container inspect data - journald` | 2026-07-08 to 2026-08-20 |  |
| 4 | `not ok \|N\| podman commit --pause default` | 2026-06-15 to 2026-08-17 | #24598 needs-check |
| 4 | `[FAIL] run basic podman commands [It] Podman ops with port forwarding and gvproxy` | 2026-06-04 to 2026-07-16 |  |
| 4 | `[FAIL] podman machine start [It] start machine already started` | 2026-06-12 to 2026-08-14 | #26547 needs-check |
| 4 | `not ok \|N\| TCP port range forwarding, IPv4, loopback` | 2026-06-04 to 2026-07-13 |  |
| 4 | `[FAIL] run cp commands [It] podman machine cp` | 2026-06-12 to 2026-08-14 | #26547 needs-check |
| 4 | `not ok [N] podman checkpoint/restore - publish with default_host_ips` | 2026-06-07 to 2026-07-07 | #24571 needs-check |
| 4 | `[FAIL] podman machine set [It] set machine cpus, disk, memory` | 2026-06-19 to 2026-08-17 |  |
| 4 | `not ok \|N\| TCP port range forwarding, IPv6, loopback` | 2026-06-01 to 2026-06-24 |  |
| 4 | `[FAIL] podman machine start [It] machine start with --update-connection` | 2026-06-02 to 2026-08-18 | #26547 needs-check |
...
| 3 | `[FAIL] podman machine start [It] start simple machine` | 2026-07-08 to 2026-08-13 | #26547 needs-check |
| 3 | `not ok \|N\| podman logs - --since --follow journald` | 2026-06-19 to 2026-08-21 | #23682 needs-check |
| 3 | `[FAIL] podman machine init [It] machine init with rosetta=false` | 2026-06-16 to 2026-08-12 | #26547 needs-check |
| 3 | `[FAIL] run basic podman commands [It] Volume ops` | 2026-07-08 to 2026-08-19 | #26547 needs-check |
...
| 3 | `[FAIL] Podman run networking [It] podman run bridge network same port different HostIPs ro` | 2026-08-17 to 2026-08-23 |  |
| 2 | `[FAIL] podman machine set [It] set rootful with docker sock change` | 2026-07-20 to 2026-08-12 |  |
| 2 | `[FAIL] podman machine restart [It] should restart a running machine` | 2026-07-29 to 2026-08-16 | #26547 needs-check |
| 2 | `[FAIL] run podman API test calls [It] client connect to machine named pipe` | 2026-07-21 to 2026-08-19 |  |
...
| 2 | `not ok \|N\| podman detects correct tty size` | 2026-07-10 to 2026-08-17 | #10710 needs-check |
...
| 2 | `not ok [N] quadlet verb - install from URL` | 2026-06-27 to 2026-08-18 |  |
...
| 2 | `[FAIL] Podman build [It] podman build with a secret from file` | 2026-06-24 to 2026-08-15 | #20485 needs-check |
| 2 | `not ok \|N\| TCP translated port range forwarding, IPv6, loopback` | 2026-06-01 to 2026-06-23 |  |
| 2 | `[FAIL] podman machine rm [It] Remove running machine` | 2026-06-23 to 2026-08-17 | #22551 needs-check |
| 2 | `not ok \|N\| UDP/IPv6 large transfer, tap` | 2026-06-23 to 2026-08-12 |  |
...
| 2 | `[FAIL] run podman API test calls [It] client connect to machine socket` | 2026-06-17 to 2026-08-13 | #22843 needs-check |
...
| 2 | `not ok \|N\| podman run docker-archive` | 2026-08-12 to 2026-08-18 | #17802 needs-check |
| 2 | `[FAIL] podman machine reset [It] reset with running machine and other machines idle` | 2026-08-14 to 2026-08-24 |  |
...
| 1 | `[FAIL] podman machine rm [It] Remove machine sharing ssh key with another machine` | 2026-08-14 | #22551 needs-check |
| 1 | `not ok \|N\| podman run --mount image` | 2026-08-14 | #24223 needs-check |
| 1 | `[FAIL] podman machine compose [DeferCleanup (Each)] compose test environment variable setu` | 2026-08-14 |  |
| 1 | `[FAIL] Podman cp [It] podman cp from ctr chown` | 2026-08-17 |  |
| 1 | `[FAIL] Podman run [It] podman run with attach stdin outputs container ID` | 2026-08-14 |  |
| 1 | `not ok \|N\| podman images - bare manifest list` | 2026-08-19 | #17193 needs-check |
| 1 | `[FAIL] podman machine start [DeferCleanup (Each)] machine start with --update-connection` | 2026-08-19 |  |
| 1 | `not ok \|N\| podman run - test force_port_listen containers.conf option` | 2026-08-24 |  |
| 1 | `[FAIL] run basic podman commands [It] podman volume on non-standard path` | 2026-08-24 |  |
...
- 9 flakes across 2: `not ok [N] podman network create`; `not ok [N] podman network reload`
...
- 6 flakes across 2: `[FAIL] podman machine start [It] machine start with --update`; `[FAIL] podman machine start [It] machine init --now with --u`
- 4 flakes across 2: `not ok \|N\| podman logs - --since --follow journald`; `not ok \|N\| podman logs - --until --follow journald`
...
- 4 flakes across 2: `[FAIL] run podman API test calls [It] client connect to mach`; `[FAIL] run podman API test calls [It] client connect to mach`
...
- 5 flakes across 3: `not ok \|N\| TCP/IPv4 large transfer, tap`; `not ok \|N\| UDP/IPv6 large transfer, tap`; `not ok \|N\| TCP/IPv6 large transfer, tap`
...
## designed failures - not real flakes (42 flakes, 3 signatures)

| n | signature | window | issue candidate |
|---|---|---|---|
| 39 | `make: *** [TARGET] Error 1` | 2026-06-02 to 2026-08-24 | #20332 needs-check |
| 2 | `make: *** [TARGET] Error 56` | 2026-06-08 to 2026-07-07 | #20332 needs-check |
| 1 | `make: *** [TARGET] Error 60` | 2026-08-11 | #20332 needs-check |

possible families - similar signatures that MAY share one cause. Kept separate above on purpose: similar names can be different failures, so merging is a human call.
- 42 flakes across 3: `make: *** [TARGET] Error 1`; `make: *** [TARGET] Error 56`; `make: *** [TARGET] Error 60`
...
## unmatched - open these by hand (140 flakes)

| n | signature | window | issue candidate |
|---|---|---|---|
| 140 | `(none)` | 2026-06-04 to 2026-08-24 |  |
