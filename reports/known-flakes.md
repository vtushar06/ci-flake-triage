...
Generated 2026-09-03. 1856 completed runs (2026-06-01 to 2026-09-03), 514 re-run by hand, 777 flakes - 493 of them in 166 signatures, the rest with no marker or no log.

The two oracles are counted separately on purpose, because the evidence behind them is not equally strong:

- **712 rerun-confirmed** - failed on one attempt and passed on a later attempt of the same run, so the commit never changed and there is a passing twin of that exact job to diff against.
...
|---|---|---|---|
| 34 | `not ok \|N\| podman healthcheck` | 2026-06-02 to 2026-08-13 | #23871 needs-check |
...
| 9 | `not ok \|N\| podman kube play --wait with siginterrupt` | 2026-06-04 to 2026-08-03 | #21560 needs-check |
| 9 | `[FAIL] podman machine set [It] set machine cpus, disk, memory` | 2026-06-19 to 2026-08-27 |  |
| 9 | `[FAIL] run basic podman commands [It] Basic ops` | 2026-06-04 to 2026-08-13 | #26547 needs-check |
| 8 | `not ok [N] podman network reload` | 2026-06-05 to 2026-08-21 | #17288 needs-check |
...
| 6 | `not ok \|N\| podman mount - basic test` | 2026-06-11 to 2026-07-29 | #24223 needs-check |
...
| 5 | `[FAIL] podman machine init [It] simple init with start` | 2026-06-15 to 2026-08-11 | #26547 needs-check |
| 5 | `[FAIL] podman machine start [It] start simple machine` | 2026-07-08 to 2026-08-21 | #26547 needs-check |
...
| 4 | `[FAIL] podman machine start [It] machine init --now with --update-connection` | 2026-06-24 to 2026-08-18 | #26547 needs-check |
| 4 | `not ok \|N\| TCP port range forwarding, IPv4, loopback` | 2026-06-04 to 2026-07-13 |  |
| 4 | `[FAIL] run cp commands [It] podman machine cp` | 2026-06-12 to 2026-08-27 | #26547 needs-check |
...
| 4 | `not ok [N] podman network create` | 2026-06-01 to 2026-08-24 | #17288 needs-check |
| 4 | `not ok \|N\| podman import` | 2026-06-10 to 2026-08-06 | #26547 needs-check |
...
| 3 | `[FAIL] podman machine start [It] start machine already started` | 2026-06-12 to 2026-08-24 | #26547 needs-check |
| 3 | `[FAIL] podman machine start [It] start machine with conflict on SSH port` | 2026-06-24 to 2026-08-24 |  |
| 3 | `[FAIL] podman machine init [It] machine init with volume` | 2026-06-26 to 2026-08-19 | #26547 needs-check |
...
## no retrievable log (166 flakes)

| n | signature | window | issue candidate |
|---|---|---|---|
| 166 | `(none)` | 2026-06-17 to 2026-09-02 |  |
