...
Generated 2026-08-29. 1732 completed runs (2026-06-01 to 2026-08-29), 482 re-run by hand, 749 flakes - 493 of them in 166 signatures, the rest with no marker or no log.
...
## test failures (458 flakes, 163 signatures)

| n | signature | window | issue candidate |
|---|---|---|---|
| 34 | `not ok \|N\| podman healthcheck` | 2026-06-02 to 2026-08-13 |  |
| 15 | `[FAIL] run cp commands [DeferCleanup (Each)] podman cp` | 2026-06-16 to 2026-08-26 |  |
| 14 | `[FAIL] podman machine init [It] machine init with cpus, disk size, memory, timezone` | 2026-06-02 to 2026-08-27 |  |
| 14 | `[FAIL] Podman prune [It] podman system prune --build clean up after terminated build` | 2026-06-02 to 2026-07-21 |  |
| 13 | `[FAIL] Podman run networking [It] podman run container with two static IPs one per subnet` | 2026-06-04 to 2026-08-19 |  |
| 12 | `[FAIL] Podman rmi [It] podman image rm - concurrent with shared layers` | 2026-06-08 to 2026-08-26 |  |
| 9 | `not ok \|N\| quadlet - image tag` | 2026-06-02 to 2026-08-07 |  |
| 9 | `not ok \|N\| podman kube play --wait with siginterrupt` | 2026-06-04 to 2026-08-03 |  |
| 9 | `[FAIL] podman machine set [It] set machine cpus, disk, memory` | 2026-06-19 to 2026-08-27 |  |
| 9 | `[FAIL] run basic podman commands [It] Basic ops` | 2026-06-04 to 2026-08-13 |  |
| 8 | `not ok [N] podman network reload` | 2026-06-05 to 2026-08-21 |  |
| 8 | `[FAIL] Podman run memory [It] podman run memory test on oomkilled container` | 2026-06-08 to 2026-08-17 |  |
| 8 | `not ok \|N\| check Go template formatting` | 2026-06-04 to 2026-08-17 |  |
| 8 | `not ok \|N\| podman update - set ulimits` | 2026-06-10 to 2026-07-13 |  |
| 7 | `[FAIL] run basic podman commands [It] Podman ops with port forwarding and gvproxy` | 2026-06-04 to 2026-08-20 |  |
| 6 | `not ok \|N\| podman run --timeout - basic test` | 2026-06-04 to 2026-07-22 |  |
| 6 | `[FAIL] Podman run [It] podman run with cgroups=split` | 2026-06-04 to 2026-07-20 |  |
| 6 | `not ok \|N\| podman mount - basic test` | 2026-06-11 to 2026-07-29 |  |
| 6 | `not ok [N] podman networking: port with --userns=keep-id for rootless or --uidmap=* for ro` | 2026-06-01 to 2026-08-14 |  |
| 6 | `not ok \|N\| podman container rm doesn't affect stopping containers` | 2026-06-02 to 2026-06-19 |  |
| 5 | `[FAIL] Podman run networking [It] podman run bridge multiple containers same network diffe` | 2026-08-10 to 2026-08-26 |  |
| 5 | `[FAIL] podman machine init [It] simple init with start` | 2026-06-15 to 2026-08-11 |  |
| 5 | `[FAIL] podman machine start [It] start simple machine` | 2026-07-08 to 2026-08-21 |  |
| 5 | `not ok [N] podman run - default_host_ips from containers.conf` | 2026-06-11 to 2026-06-28 |  |
| 5 | `[FAIL] Podman build [It] podman build --build-context: URL source` | 2026-06-12 to 2026-08-21 |  |
...
| 4 | `not ok \|N\| events - container inspect data - journald` | 2026-07-08 to 2026-08-14 |  |
| 4 | `[FAIL] podman machine start [It] machine init --now with --update-connection` | 2026-06-24 to 2026-08-18 |  |
| 4 | `not ok \|N\| TCP port range forwarding, IPv4, loopback` | 2026-06-04 to 2026-07-13 |  |
| 4 | `[FAIL] run cp commands [It] podman machine cp` | 2026-06-12 to 2026-08-27 |  |
| 4 | `not ok [N] podman checkpoint/restore - publish with default_host_ips` | 2026-06-07 to 2026-07-07 |  |
| 4 | `[FAIL] podman machine ssh [It] verify machine rootfulness` | 2026-06-19 to 2026-08-22 |  |
| 4 | `not ok [N] podman network create` | 2026-06-01 to 2026-08-24 |  |
| 4 | `not ok \|N\| podman import` | 2026-06-10 to 2026-08-06 |  |
| 4 | `not ok \|N\| TCP port range forwarding, IPv6, loopback` | 2026-06-01 to 2026-06-24 |  |
| 4 | `[FAIL] podman machine proxy settings propagation [It] ssh to running machine and check pro` | 2026-06-15 to 2026-08-20 |  |
| 3 | `[FAIL] podman machine start [It] start two machines in parallel` | 2026-07-08 to 2026-08-10 |  |
...
| 3 | `not ok \|N\| podman commit --pause default` | 2026-06-15 to 2026-07-21 |  |
| 3 | `[FAIL] podman machine start [It] start machine already started` | 2026-06-12 to 2026-08-24 |  |
| 3 | `[FAIL] podman machine start [It] start machine with conflict on SSH port` | 2026-06-24 to 2026-08-24 |  |
| 3 | `[FAIL] podman machine init [It] machine init with volume` | 2026-06-26 to 2026-08-19 |  |
...
| 3 | `not ok \|N\| podman kube play healthcheck should wait initialDelaySeconds before updating st` | 2026-06-02 to 2026-06-29 |  |
...
| 3 | `[FAIL] podman machine start [It] machine start with --update-connection` | 2026-06-02 to 2026-06-15 |  |
| 3 | `not ok \|N\| podman play with image volume (automount annotation and OCI VolumeSource)` | 2026-06-02 to 2026-08-22 |  |
...
| 2 | `not ok \|N\| podman logs - --since --follow journald` | 2026-06-19 to 2026-07-26 |  |
| 2 | `[FAIL] podman machine init [It] machine init with rosetta=false` | 2026-06-16 to 2026-07-13 |  |
| 2 | `[FAIL] Podman port [It] podman port multiple ports` | 2026-06-30 to 2026-07-13 |  |
| 2 | `not ok \|N\| podman images with concurrent removal` | 2026-06-24 to 2026-07-08 |  |
| 2 | `[FAIL] podman machine init [It] machine init rootful with docker.sock check` | 2026-06-16 to 2026-07-07 |  |
| 2 | `not ok \|N\| podman network - basic tests` | 2026-06-24 to 2026-07-07 |  |
| 2 | `[FAIL] podman machine init [It] machine init rootless docker.sock check` | 2026-07-02 to 2026-07-06 |  |
...
| 2 | `[FAIL] Podman port [It] podman port -l nginx` | 2026-06-04 to 2026-06-11 |  |
...
| 1 | `[FAIL] Podman port [It] podman port nginx by name` | 2026-08-11 |  |
| 1 | `not ok \|N\| podman mount no-dereference` | 2026-08-09 |  |
| 1 | `not ok \|N\| podman cp file from container to container` | 2026-08-04 |  |
| 1 | `[FAIL] podman machine restart [It] should restart a running machine` | 2026-07-29 |  |
...
| 1 | `[FAIL] Podman checkpoint [It] podman checkpoint and run exec in restored container` | 2026-07-19 |  |
| 1 | `[FAIL] podman machine init [It] machine init with swap` | 2026-07-17 |  |
...
| 1 | `not ok \|N\| podman detects correct tty size` | 2026-07-10 |  |
| 1 | `[FAIL] podman machine start [DeferCleanup (Each)] start two machines in parallel` | 2026-07-09 |  |
| 1 | `[FAIL] run basic podman commands [It] Volume ops` | 2026-07-08 |  |
| 1 | `not ok \|N\| podman run -l passthrough-tty` | 2026-07-08 |  |
| 1 | `[FAIL] podman machine stop [It] Stop running machine` | 2026-07-08 |  |
...
| 1 | `[FAIL] run podman API test calls [It] curl connect to machine socket` | 2026-07-01 |  |
...
| 1 | `[FAIL] run cp commands [It] podman cp` | 2026-06-29 |  |
...
| 1 | `[FAIL] Podman port [It] podman port -l port nginx` | 2026-06-26 |  |
| 1 | `[FAIL] Podman run networking [It] podman run with macvlan network` | 2026-06-24 |  |
| 1 | `[FAIL] TOP-LEVEL [AfterEach] Podman kube play test with reserved Seccomp annotation in yam` | 2026-06-24 |  |
| 1 | `not ok \|N\| Single TCP port forwarding, IPv4, tap` | 2026-06-24 |  |
| 1 | `[FAIL] Podman build [It] podman build with a secret from file` | 2026-06-24 |  |
...
| 1 | `[FAIL] podman machine rm [It] Remove running machine` | 2026-06-23 |  |
...
| 1 | `[FAIL] Podman checkpoint [It] podman checkpoint and restore containers with --print-stats` | 2026-06-21 |  |
| 1 | `[FAIL] Podman checkpoint [It] podman checkpoint and restore container with different port ` | 2026-06-19 |  |
| 1 | `[FAIL] Podman port [It] podman port -a nginx` | 2026-06-19 |  |
...
| 1 | `[FAIL] podman machine list [It] list machine: check if running while starting` | 2026-06-17 |  |
| 1 | `[FAIL] run podman API test calls [It] client connect to machine socket` | 2026-06-17 |  |
...
| 1 | `not ok \|N\| podman logs - --until --follow journald` | 2026-06-15 |  |
...
| 1 | `not ok \|N\| podman cp file from container to host` | 2026-06-11 |  |
...
| 1 | `not ok \|N\| podman checkpoint/restore ip and mac handling` | 2026-06-05 |  |
...
| 1 | `[FAIL] Podman logs [It] tail two lines: k8s-file` | 2026-06-03 |  |
| 1 | `not ok bud-multiple-platform-failure` | 2026-06-03 |  |
| 1 | `[FAIL] Podman checkpoint [It] podman restore container with tcp-close` | 2026-06-02 |  |
| 1 | `[FAIL] Podman commit [It] podman commit container with --squash` | 2026-06-01 |  |
| 1 | `not ok \|N\| TCP translated port range forwarding, IPv4, tap` | 2026-06-01 |  |
| 1 | `not ok \|N\| quadlet kube - start error` | 2026-06-01 |  |
...
| 1 | `not ok \|N\| podman run docker-archive` | 2026-08-12 |  |
...
- 12 flakes across 2: `not ok [N] podman network reload`; `not ok [N] podman network create`
- 7 flakes across 2: `not ok \|N\| podman mount - basic test`; `not ok \|N\| podman stop - basic test`
- 8 flakes across 4: `[FAIL] Podman build [It] podman build --build-context: URL s`; `[FAIL] Podman build [It] podman build --build-context: local`; `[FAIL] Podman build [It] podman build --build-context: Image`; `[FAIL] Podman build [It] podman build --build-context: Mixed`
- 7 flakes across 2: `[FAIL] podman machine start [It] machine init --now with --u`; `[FAIL] podman machine start [It] machine start with --update`
...
- 4 flakes across 2: `[FAIL] podman machine init [It] machine init with volume`; `[FAIL] podman machine init [It] machine init with swap`
...
| n | signature | window | issue candidate |
|---|---|---|---|
| 32 | `make: *** [TARGET] Error 1` | 2026-06-02 to 2026-08-13 |  |
| 2 | `make: *** [TARGET] Error 56` | 2026-06-08 to 2026-07-07 |  |
| 1 | `make: *** [TARGET] Error 60` | 2026-08-11 |  |
